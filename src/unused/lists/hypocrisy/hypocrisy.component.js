...
import NewsLink from '@/lists/news-link';
      ...
      <List header="Changing circumstances">
        <div>
          ...
          <TweetLink id="874767922295705600">
            06/2017 - Good:{' '}
            <span>
              "Accountability and Whistleblower Protection Act is GREAT news...I look forward to
              signing it!"
            </span>
          </TweetLink>
          <TweetLink id="1178651638313226240">
            09/2019 - Bad:{' '}
            <span>
              "WHO CHANGED THE LONG STANDING WHISTLEBLOWER RULES JUST BEFORE SUBMITTAL OF THE FAKE
              WHISTLEBLOWER REPORT?"
            </span>
          </TweetLink>
          <TweetLink id="1178442759499370496">
            09/2019 - Misunderstanding:{' '}
            <span>
              "Like every American, I deserve to meet my accuser...the so-called Whistleblower"
            </span>
          </TweetLink>
        </div>
        <div>
          ...
          <TweetLink id="208624252230963200">
            01/2012 - Bad:{' '}
            <span>"Over $1T in annual deficit spending...The great Obama recovery."</span>
          </TweetLink>
          <NewsLink
