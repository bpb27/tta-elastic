...
export default class BadHires extends React.Component {
  render () {
    return (
      <React.Fragment>
        <MetaTags>
          <title>TTA - Bad Hires</title>
          <meta name="description" content="Trump says he uses the best people, but later tweets one was 'dumb as a rock'." />
          <meta property="og:title" content="Bad Hires on Trump Twitter Archive" />
        </MetaTags>
