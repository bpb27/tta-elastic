  ...
  render () {
    return (
      ...
      >
        ...
        <section>
          <GraphGDPQuarterly/>
          <Paragraph externalLinkProps={{ title: 'Video on RealClearPolitics', href: 'https://www.realclearpolitics.com/video/2017/12/16/trump_were_going_to_see_economy_growth_of_4_5_and_maybe_6_percent.html' }} type="quote">
        ...
        <section>
          ...
          <Paragraph>
            The slow return of manufacturing jobs started in 2010 and continued steadily until a crash this summer.
          </Paragraph>
        </section>
        <section>
          <GraphFamilyIncome/>
          <Paragraph externalLinkProps={{ tweetId: '959946200488271872' }} type="quote">
            After many years, rising wages - and nobody even talks about them. Only Russia, Russia, Russia...No Collusion!
          </Paragraph>
          <Paragraph>
            Family income has been steadily rising since 2011, though will almost certainly see a decline in 2020.
          </Paragraph>
        </section>
        <section>
          <GraphDebt/>
